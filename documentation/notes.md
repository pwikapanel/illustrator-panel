...
https://github.com/Adobe-CEP/CEP-Resources/issues/376
https://github.com/Adobe-CEP/CEP-Resources/issues/378

Cookies will fail in CEP panels if upgraded
...
```
rsync -vaPur --delete -n root@apache.svija.com:/home/tools.svija.com/master/ ./local/
```
...
[l1]: https://github.com/svijasvg/scripts-presets
