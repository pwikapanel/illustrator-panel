...
```
vi -O Svija\ Tools/CSXS/manifest.xml Svija\ Tools/panel/lessHelp.html Svija\ Tools/panel/moreHelp.html
```
...
```
vi -O README.md Svija\ Tools\ Beta/js/version.js Svija\ Tools\ Beta/CSXS/manifest.xml
```
