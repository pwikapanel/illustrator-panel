...
while (app.documents.length > 0){
  ...
  var svgOptions = st_getSvgOptions(sourceDoc.artboards.length);
  ...
  st_deleteNonPrintingLayers(sourceDoc);
...
//     sourceDoc.exportFile(destFolder, ExportType.SVG, svgOptions);
//   else {
//     var destDoc = this.st_getTargetFile(sourceDoc.name, '.svg', destFolder);
...
function st_getTargetFile(docName, ext, destFolder) {
  var newName = "";
