...
if (aiVersion > 0) aiver =  '(Illust. '+aiVersion+')'; else aiver = '';

//———————————————————————————————————————— localization

// FR
var files_saved      = 'Fichier(s) sauvegardé(s)';
var access_is_denied = 'Accès refusé';

// EN
var files_saved      = 'File(s) saved';
var access_is_denied = 'Access is denied';

//———————————————————————————————————————— run program

var thisFolder = Folder(app.activeDocument.path);
var destFolder = thisFolder;
var docList  = [];

var aiOptions = getAiOptions();
...
if (alert_done) alert(files_saved);
...
function getAiOptions(){
  ...
  // Options for saving a document as an Illustrator file, used with the saveAs method.
  // alt-cmd-G 84 in the guide
