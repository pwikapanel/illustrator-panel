// 13 buttons: link0 ... link12

var how_many = 13;

for (x=0; x<how_many; x++){
  var obj = document.getElementById('link' + x);
  obj.addEventListener('mouseover', mov.bind(null, x), false);
  obj.addEventListener('mouseout',  mot.bind(null, x), false);
  obj.addEventListener('mousedown', mod.bind(null, x), false);
  obj.addEventListener('mouseup',   exe.bind(null, x), false);
}
//———————————————————————————————————————— add listeners
